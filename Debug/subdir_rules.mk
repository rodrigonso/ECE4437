...
build-298669937:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-298669937-inproc

build-298669937-inproc: ../main.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-298669937 ../main.cfg
configPkg/compiler.opt: build-298669937
configPkg/: build-298669937
